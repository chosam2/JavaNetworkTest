...
public class TCPServer {
	public static void main(String[] args) throws IOException {
		...
		Socket socket = server.accept(); // 접속된 사용자(Client)의 소켓 객체를 담아줌

		// ---------------------------------------------------------
		// 이 이후는 클라이언트와 연결된 후의 작업을 진행하면 된다.

		System.out.println("접속한 클라이언트 정보");
		System.out.println("주소 : " + socket.getInetAddress()); // IP주소 얻을때
...
//		dos.writeUTF("어서오세요..."); // 메시지 보내기
		dos.writeUTF("민현이형 사랑해, 준수형 사랑해, 혁준이형 사랑해, 승태형 사랑해");
